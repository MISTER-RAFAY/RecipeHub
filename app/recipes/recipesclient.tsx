...
export const allRecipes = [
  { id: 1, title: "Mozzarella Sticks", time: "15 min", imageSrc: "/mozrella.jpg", desc: "Crispy cheesy goodness.", category: "appetizers" },
  { id: 2, title: "Bruschetta", time: "10 min", imageSrc: "/Burchestta.png", desc: "Tomato and basil on toast.", category: "appetizers" },
  { id: 3, title: "Chicken Wings", time: "30 min", imageSrc: "https://images.unsplash.com/photo-1567620832903-9fc6debc209f?q=80&w=600&auto=format&fit=crop", desc: "Spicy buffalo wings.", category: "appetizers" },
  { id: 4, title: "Grilled Ribeye Steak", time: "45 min", imageSrc: "https://images.unsplash.com/photo-1600891964092-4316c288032e?q=80&w=600&auto=format&fit=crop", desc: "Perfectly seared beef.", category: "main-courses" },
  { id: 5, title: "Roast Chicken", time: "60 min", imageSrc: "/Roastchicken.jpg", desc: "Herb crusted whole chicken.", category: "main-courses" },
  { id: 6, title: "Vegetable Lasagna", time: "50 min", imageSrc: "https://images.unsplash.com/photo-1619895092538-128341789043?q=80&w=600&auto=format&fit=crop", desc: "Cheesy pasta layers.", category: "main-courses" },
  { id: 7, title: "Spaghetti Bolognese", time: "35 min", imageSrc: "https://images.unsplash.com/photo-1622973536968-3ead9e780960?q=80&w=600&auto=format&fit=crop", desc: "Classic Italian meat sauce.", category: "main-courses" },
  { id: 102, title: "Avocado Toast", time: "10 min", imageSrc: "/Avocado.jpg", desc: "Healthy breakfast choice.", category: "breakfast" },
  { id: 303, title: "Grilled Salmon", time: "25 min", imageSrc: "https://images.unsplash.com/photo-1485921325833-c519f76c4927?q=80&w=600&auto=format&fit=crop", desc: "Rich in Omega-3.", category: "dinner" },
  { id: 401, title: "Lava Cake", time: "40 min", imageSrc: "/Lava.jpg", desc: "Decadent dessert.", category: "desserts" },
];

type Recipe = typeof allRecipes[0];

const RecipesContent = ({ recipes }: { recipes: Recipe[] }) => {
            ...
            {filteredRecipes.map((recipe) => (
              <div key={recipe.id} className="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow overflow-hidden group">
                <div className="relative h-48 w-full bg-gray-100">
                  <Image
                    src={recipe.imageSrc}
                    alt={`${recipe.title} – easy ${recipe.category.replace("-", " ")} recipe on RecipeHub`}
                    fill
...
const RecipesPage = ({ recipes }: { recipes: Recipe[] }) => {
  return (
